...
## RGB LEDs
#set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { r_led }]; #IO_L23N_T3_FWE_B_15 Sch=led0_r
...
## Buttons
#set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { btn_reset }]; #IO_L18N_T2_A23_15 Sch=btn[0]
