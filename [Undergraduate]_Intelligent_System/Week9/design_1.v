...
module design_1
  ...
  wire [11:0]SRAM1_bram_addr_a;
  wire SRAM1_bram_clk_a;
  wire SRAM1_bram_en_a;
  wire [3:0]SRAM1_bram_we_a;
  wire [31:0]SRAM1_bram_wrdata_a;
  wire [11:0]SRAM2_bram_addr_a;
  wire SRAM2_bram_clk_a;
  wire SRAM2_bram_en_a;
  wire [3:0]SRAM2_bram_we_a;
  wire [31:0]SRAM2_bram_wrdata_a;
  wire csr_0_start;
  ...
  wire top_memory_ctrlr_0_done;
  wire [15:0]top_memory_ctrlr_0_s1_douta;
  wire [31:0]top_memory_ctrlr_0_s2_douta;
  ...
  design_1_axi_bram_ctrl_0_2 SRAM1
       (.bram_addr_a(SRAM1_bram_addr_a),
        .bram_clk_a(SRAM1_bram_clk_a),
        .bram_en_a(SRAM1_bram_en_a),
        .bram_rddata_a(xlconcat_0_dout),
        .bram_we_a(SRAM1_bram_we_a),
        .bram_wrdata_a(SRAM1_bram_wrdata_a),
  ...
  design_1_axi_bram_ctrl_0_3 SRAM2
       (.bram_addr_a(SRAM2_bram_addr_a),
        .bram_clk_a(SRAM2_bram_clk_a),
        .bram_en_a(SRAM2_bram_en_a),
        .bram_rddata_a(top_memory_ctrlr_0_s2_douta),
        .bram_we_a(SRAM2_bram_we_a),
        .bram_wrdata_a(SRAM2_bram_wrdata_a),
        .s_axi_aclk(processing_system7_0_FCLK_CLK0),
  ...
  design_1_csr_0_0 csr_0
       (.done(top_memory_ctrlr_0_done),
  ...
  design_1_ila_0_0 ila_0
       (.clk(processing_system7_0_FCLK_CLK0),
        .probe0(csr_0_start),
        .probe1(top_memory_ctrlr_0_done),
        .probe10(SRAM2_bram_wrdata_a),
        .probe11(top_memory_ctrlr_0_s2_douta),
        .probe2(SRAM1_bram_en_a),
        .probe3(xlslice_1_Dout),
        .probe4(xlslice_0_Dout),
        .probe5(xlslice_2_Dout),
        .probe6(top_memory_ctrlr_0_s1_douta),
        .probe7(SRAM2_bram_en_a),
        .probe8(SRAM2_bram_we_a),
        .probe9(xlslice_3_Dout));
  ...
  design_1_smartconnect_0_0 smartconnect_0
       (.M00_AXI_araddr(smartconnect_0_M00_AXI_ARADDR),
        ...
        .aresetn(1'b1));
  design_1_top_memory_ctrlr_0_0 top_memory_ctrlr_0
       (.clk(processing_system7_0_FCLK_CLK0),
        .done(top_memory_ctrlr_0_done),
        .resetn(rst_ps7_0_100M_peripheral_aresetn),
        .s1_addra(xlslice_0_Dout),
        .s1_clka(SRAM1_bram_clk_a),
        .s1_dina(xlslice_2_Dout),
        .s1_douta(top_memory_ctrlr_0_s1_douta),
        .s1_ena(SRAM1_bram_en_a),
        .s1_wea(xlslice_1_Dout),
        .s2_addra(xlslice_3_Dout),
        .s2_clka(SRAM2_bram_clk_a),
        .s2_dina(SRAM2_bram_wrdata_a),
        .s2_douta(top_memory_ctrlr_0_s2_douta),
        .s2_ena(SRAM2_bram_en_a),
        .s2_wea(SRAM2_bram_we_a),
        .start(csr_0_start));
  design_1_xlconcat_0_1 xlconcat_0
       (.In0(top_memory_ctrlr_0_s1_douta),
        .In1(xlconstant_0_dout),
        .dout(xlconcat_0_dout));
  design_1_xlconstant_0_0 xlconstant_0
       (.dout(xlconstant_0_dout));
  design_1_xlslice_0_0 xlslice_0
       (.Din(SRAM1_bram_addr_a),
        .Dout(xlslice_0_Dout));
  design_1_xlslice_1_0 xlslice_1
       (.Din(SRAM1_bram_we_a),
        .Dout(xlslice_1_Dout));
  design_1_xlslice_2_0 xlslice_2
       (.Din(SRAM1_bram_wrdata_a),
        .Dout(xlslice_2_Dout));
  design_1_xlslice_3_0 xlslice_3
       (.Din(SRAM2_bram_addr_a),
        .Dout(xlslice_3_Dout));
endmodule
