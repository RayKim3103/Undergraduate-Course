...
public class DroppableUI : MonoBehaviour, IPointerEnterHandler, IDropHandler, IPointerExitHandler
{
	...
	/* Scroll Panel 정보를 담을 변수 */
    public string scrollTag = "ScrollPanel"; // ScrollPanel 오브젝트의 태그
	...
	private void Awake()
	{
		...
		rect	= GetComponent<RectTransform>();
 		scrollPanel = GameObject.FindWithTag(scrollTag);
	}
	...
	public void OnDrop(PointerEventData eventData)
	{
		...
		if ( eventData.pointerDrag != scrollPanel)
		{
			Debug.Log("드래그 중인 것: " + eventData.pointerDrag);
