...
public class MageSkillSelection : MonoBehaviour
{
//     // 열거형 변수 선언
...
//     private MageController skillReceiver;

//     private void Awake() 
//     {
//         //player = GameObject.FindWithTag(playerTag);
//         skillReceiver = gameObject.GetComponent<MageController>();
//     }
...
//         newSlot.GetComponent<MageSkillSlot>().Setup(newSkill);
//     }
