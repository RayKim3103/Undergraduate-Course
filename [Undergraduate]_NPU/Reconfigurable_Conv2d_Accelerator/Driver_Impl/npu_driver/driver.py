...
class NPUDriver:
    ...
    def config_layer(self, layer_config):
        self.write_csr(0x08, layer_config.kernel_w)
        self.write_csr(0x0C, layer_config.kernel_h)
        self.write_csr(0x10, layer_config.input_ch)
        self.write_csr(0x14, layer_config.input_w)
        self.write_csr(0x18, layer_config.input_h)
        self.write_csr(0x1C, layer_config.output_ch)
    ...
    def run_fc_2d(self, i_act, weight, tile_h=3, tile_w=3, tile_oc=1):
        ...
        input_reshaped, weight_reshaped = self.reshape_input_and_weights(i_act, weight, 3, output_ch_before)
